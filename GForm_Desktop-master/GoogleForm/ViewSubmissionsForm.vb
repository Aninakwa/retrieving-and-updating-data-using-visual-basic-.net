...
Public Class ViewSubmissionsForm
    ...
    Public Sub New()
        ...
        client.BaseAddress = New Uri("http://localhost/submissions_api/")
    ...
    Private Async Function LoadSubmission(index As Integer) As Task(Of Submission)
        Dim response As HttpResponseMessage = Await client.GetAsync($"read.php?index={index}")
    ...
    Private Async Sub BtnEditSubmission_Click(sender As Object, e As EventArgs) Handles BtnEditSubmission.Click
        ...
        Dim response = Await client.PutAsync($"update.php?index={currentIndex}", content)
        If response.IsSuccessStatusCode Then
    ...
    Private Async Sub BtnDeleteSubmission_Click(sender As Object, e As EventArgs) Handles BtnDeleteSubmission.Click
        Dim response = Await client.DeleteAsync($"delete.php?index={currentIndex}")
        If response.IsSuccessStatusCode Then
